...
def upload_img():
    ...
    if request.method == 'POST' or request.method == 'GET':
        ...
        if file:# and allowed_file(file.filename):
            ...
            images = {'image0':image_list[0],'image1':image_list[1],'image2':image_list[2],'image3':image_list[3],'image4':image_list[4],
			'image5':image_list[5],'image6':image_list[6],'image7':image_list[7],'image8':image_list[8],'tags':tags}
